...
$wssv      = isset($_POST['wssv']);
$tsv       = isset($_POST['tsv']);
$ihhnv     = isset($_POST['ihhnv']);
$imnv      = isset($_POST['imnv']);
$yhv       = isset($_POST['yhv']);
$mrnv      = isset($_POST['mrnv']);
$pvnv      = isset($_POST['pvnv']);
$ahpnd_ems = isset($_POST['ahpnd_ems']);
$ehp       = isset($_POST['ehp']);
$nhpb      = isset($_POST['nhpb']);
$div1      = isset($_POST['div1']);
