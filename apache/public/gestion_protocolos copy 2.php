        ...
        <div id="contenido-pestanas" >
            <div id="tab_datos" class="tab-content" style="display:block;">
                    ...
                    <div class="panel-formulario">
                        ...
                        <!-- reciboss -->
                         <?php
                            $rolSesion = strtolower(trim($_SESSION["usuario"]["rol_nombre"]  ?? ''));
        ...
        .then(protocolos => {
            ...
            if (protocolos.length === 0 && pagina === 1) {
                ...
                protocolos.forEach(p => {
                    ...
                    li.innerHTML = `<a href="gestion_protocolos.php?id=${p.id_protocolo}">Protocolo:${p.id_protocolo} <br/>Cliente:${p.id_cliente} - ${p.nombre}  <br/>Fecha: ${p.fecha}</a>`;
